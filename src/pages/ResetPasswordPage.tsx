...
import { Zap, Lock, ArrowLeft, CheckCircle2, ShieldCheck } from "lucide-react";
        ...
        <div className="relative rounded-3xl overflow-hidden">
          ...
          <div className="p-8 md:p-10 bg-card/60 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-[0_0_80px_-20px_rgba(0,255,255,0.1)]">
            ...
            <div className="text-center mb-10">
              ...
              >
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-purple-500">New Password</span>
              </motion.h1>
              <motion.p
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                {success ? "Your password is ready to use" : "Create a secure password for your account"}
              </motion.p>
            </div>
            ...
            {!success ? (
              ...
              >
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="confirmPassword" className="text-gray-300 text-sm font-medium flex items-center gap-1.5">
                    <CheckCircle2 className="w-3.5 h-3.5 text-primary/60" />
                    Confirm Password
                  </Label>
                  <div className={`relative rounded-xl transition-all duration-300 ${focused === "confirmPassword" ? "shadow-[0_0_20px_-5px_rgba(0,255,255,0.2)]" : ""}`}>
                    <Input
                      id="confirmPassword"
                      type="password"
                      required
                ...
                >
                  <span className="relative z-10 flex items-center justify-center gap-2">
                    {loading ? (
                      ...
                      <>
                        Update Password <Zap className="w-4 h-4 transition-transform" />
                      </>
                    )}
                  </span>
